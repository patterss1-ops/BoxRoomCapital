...
| ticket_id | title | owner | status | deps | file_scope | branch | commit_head | handoff_ref | acceptance_criteria | updated_utc |
|---|---|---|---|---|---|---|---|---|---|---|
| A-001 | Broker capability schema | codex | READY | none | `broker/base.py`, `execution/policy/**`, `tests/**capability**` | `codex/a-001-broker-capability-schema` | `-` | `-` | Capability matrix enforced pre-trade; tests pass | 2026-02-28T13:05:00Z |
...
| A-003 | IBKR paper adapter (MVP) | claude | READY | A-001 (A-002 for full wiring) | `broker/ibkr.py`, `tests/**ibkr**` | `claude/a-003-ibkr-paper-adapter` | `-` | `-` | Connect, submit, cancel, status flow for paper lane | 2026-02-28T13:05:00Z |
