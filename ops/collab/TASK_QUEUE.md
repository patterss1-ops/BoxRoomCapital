...
| A-012 | Main merge sequencing | codex | REVIEW | A-001..A-011 | `ops/collab/**`, merge metadata, branch integration | `codex/a-012-main-merge-phase-a` | `2def2b6` | `ops/collab/HANDOFFS/20260228-1403Z-codex-A-012.md` | Phase A merge-candidate branch from `main` with validated tests and resolved metadata refs | 2026-02-28T14:03:57Z |
