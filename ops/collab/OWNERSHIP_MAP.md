...
| G-002 | claude | shared | `fund/execution_quality.py`, `app/api/server.py` (execution quality endpoints only), `app/web/templates/_execution_quality.html`, `tests/test_execution_quality.py`, `tests/test_api_execution_quality.py` | G-001, G-004 | G-001 then G-002 then G-004 | claimed | 2026-03-02T18:15:00Z |
