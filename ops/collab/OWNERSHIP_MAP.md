...
| F-002 | claude | exclusive | `intelligence/finra_short_interest.py`, `app/signal/layers/short_interest.py`, `tests/test_signal_layer_short_interest.py` | F-001 | F-001 then F-002 | claimed | 2026-03-02T13:00:00Z |
| F-003 | claude | exclusive | `intelligence/capitol_trades_client.py`, `app/signal/layers/congressional.py`, `tests/test_signal_layer_congressional.py` | F-001 | F-001 then F-003 | claimed | 2026-03-02T13:00:00Z |
| F-004 | codex | exclusive | `intelligence/news_sentiment.py`, `app/signal/layers/news_sentiment.py`, `tests/test_signal_layer_news_sentiment.py` | F-001 | F-001 then F-004 | claimed | 2026-03-02T11:43:13Z |
| F-005 | claude | exclusive | `app/signal/layers/technical_overlay.py`, `tests/test_signal_layer_technical_overlay.py` | F-001 | F-001 then F-005 | claimed | 2026-03-02T13:00:00Z |
