...
| B-001 | codex | exclusive | `intelligence/webhook_server.py`, `app/api/server.py` (webhook endpoints only), `config.py` (webhook settings only), `tests/test_api_webhook_intake.py` | B-004 | B-001 then B-004 | claimed | 2026-02-28T18:29:09Z |
...
| B-003 | claude | exclusive | `risk/portfolio_risk.py`, `fund/nav.py`, `fund/report.py`, `data/trade_db.py` (fund/risk tables only), `tests/test_portfolio_risk.py`, `tests/test_fund_nav.py`, `tests/test_fund_report.py` | B-004 | B-003 then B-004 | claimed | 2026-02-28T19:35:00Z |
| B-004 | codex | exclusive | `app/api/server.py` (risk briefing routes only), `app/web/templates/overview.html`, `app/web/templates/_risk_briefing.html`, `tests/test_api_risk_briefing.py` | B-001, B-003 | B-001/B-003 then B-004 | claimed | 2026-02-28T18:20:21Z |
