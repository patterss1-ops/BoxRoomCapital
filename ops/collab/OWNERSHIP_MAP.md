...
| F-001 | codex | exclusive | `app/signal/layer_registry.py`, `app/signal/contracts.py` (layer metadata hooks only), `tests/test_signal_layer_registry.py` | F-002, F-003, F-004, F-005 | F-001 first to freeze remaining tier-1 layer contract | claimed | 2026-03-02T11:25:12Z |
