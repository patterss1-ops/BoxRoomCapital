...
| F-008 | claude | shared | `tests/test_signal_engine_e2e.py`, `ops/collab/release-checks/signal_engine_checks.sh`, `ops/collab/HANDOFFS/**` | F-007 | F-007 then F-008 | claimed | 2026-03-02T16:30:00Z |
